...
--pheno /data/scratch/bt23761/gwas_sum/ICD10data.txt \
--mpheno 1 \
--out /data/scratch/bt23761/gwas_sum/allover/all_$nm"_"model \
--maf 0.001 \
--geno 0.02 \
--info 0.7 \
--covar /data/scratch/bt23761/gwas_sum/CAcovar.txt \
...
--load-model /data/scratch/bt23761/gwas_sum/allover/all_$nm"_"model.fastGWA \
--maf 0.001 --geno 0.02 --info 0.7 \
--out /data/scratch/bt23761/gwas_sum/allover/all_$nm"_"23 \
--thread-num ${NSLOTS}         # Use the number of slots allocated for parallel processing
